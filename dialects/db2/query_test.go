//
// Query tests - Abstracted from the gorm tests
//
...
func TestStringPrimaryKeyForNumericValueStartingWithZero(t *testing.T) {
	...
	type AddressByZipCode struct {
		ZipCode string `gorm:"primary_key;not null;column:ZIPCODE"`
		Address string `gorm:"column:ADDRESS"`
	}
	DB.DropTable(&AddressByZipCode{})
...
func TestSearchWithMap(t *testing.T) {
	...
	user4 := User{Name: "MapSearchUser4", Age: 30, Birthday: parseTime("2020-1-1")}
